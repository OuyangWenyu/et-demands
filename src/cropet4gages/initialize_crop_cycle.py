...
class InitializeCropCycle:
    ...
    def setup_crop(self, crop):
        ...
        if self.zr_min > zr_dormant:
            ...
            self.depl_root = (self.depl_root + (taw3 - daw3) * (self.zr_min - zr_dormant) / (self.zr_max - zr_dormant))
            ...
            daw3 = (daw3 + (zr_dormant - self.zr_min) / zr_dormant * (self.aw * zr_dormant - self.depl_root))
    ...
    def setup_dormant(self, et_cell, crop):
        ...
        if zr_dormant < self.zr:
            ...
            if zr_dormant > ze:
                totwatinzr_dormant = ((self.totwatin_ze + aw_root * (zr_dormant - ze)) * (
                        1 - self.fc) + aw_root * zr_dormant * self.fc)
            else:
                totwatinzr_dormant = ((self.totwatin_ze * (1 - (ze - zr_dormant) / ze)) * (
                            1 - self.fc) + aw_root * zr_dormant * self.fc)  # corrected
