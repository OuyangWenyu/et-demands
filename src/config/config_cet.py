...
__CET.CROP_ET.crop_coefs_name = "CropCoefs_etr.txt"
...
__CET.REFET = edict()
__CET.REFET.refet_type = "ETr"
__CET.REFET.refet_folder = "climate"
__CET.REFET.name_format = "gridmet_historical_%s.csv"
