...
def main(overwrite_flag=False):
    ...
    site_url = cfg_prep.USDA.usda_site_url
    site_folder = cfg_prep.USDA.usda_site_folder

    cdl_ws = cfg_prep.USDA.cdl_folder
    cdl_year = cfg_prep.USDA.cdl_year
    cdl_format = cfg_prep.USDA.cdl_format
